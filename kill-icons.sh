...
# Add desired apps (Safari, App Store, System Settings)
...
# Notification
osascript -e 'display notification "Dock updated with Safari, App Store, and System Settings" with title "Dock Configured"'